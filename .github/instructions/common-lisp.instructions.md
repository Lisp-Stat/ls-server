...
- Use `describe` to get information about a symbol: `(describe 'symbol-name)`
- Use `apropos` to search for symbols by name: `(apropos "search-term")`
- Use `documentation` to get the docstring of a variable or function: `(documentation 'symbol-name 'variable)` or `(documentation 'symbol-name 'function)`
